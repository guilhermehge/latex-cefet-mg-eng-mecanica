...
%   Edição para o departamento de engenharia mecânica: Guilherme H. G. Elias <guilhermehge@hotmail.com>
%
% -----------------------------------------------------------------------------
...
\usepackage{multirow}										%Tabela com múltiplas colunas
%\usepackage{csvsimple}                                      %importar tabelas do Excel
...
\usepackage{textcomp}										%Permite o uso do caractere de graus através de \textdegree
...
\usepackage[enumerate,autolinebreaks,useliterate,framed,numbered]{mcode}
...
\include{./02-elementos-textuais/fundamentacao-teorica}     % Revisão Bibliográfica
\include{./02-elementos-textuais/trabalhos-relacionados}
